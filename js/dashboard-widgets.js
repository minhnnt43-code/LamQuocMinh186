...
const renderAIQuote = async () => {
    ...
    todayQuote = { quote: randomQuote, date: new Date().toISOString() };
...
const renderWeather = async () => {
    ...
    // Fallback static weather since AI is disabled
    let weatherData = { temp: "28", desc: "Trời đẹp", humidity: "70", icon: "sunny" };
