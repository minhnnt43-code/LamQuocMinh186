...
export class KanbanBoard {
    ...
    renderCard(task) {
        ...
        // [SMART] Dùng autoColor từ rules-engine cho ribbon (nếu có)
        const ribbonColor = task.autoColor || priorityColor;
        ...
        return `
            <div class="kanban-card kanban-card-v2" 
                ...
                <!-- Priority Ribbon -->
                <div class="card-ribbon" style="background: ${ribbonColor}"></div>
                ...
                <!-- Title -->
                <div class="card-title-v2">${task.autoIcon ? task.autoIcon + ' ' : ''}${task.name || 'Untitled'}</div>
                ...
                <div class="card-footer-v2">
                    <div class="card-tags">
                        ...
                        ${task.category ? `<span class="card-category" style="background: ${ribbonColor}15; color: ${ribbonColor}; border: 1px solid ${ribbonColor}30">${task.category}</span>` : ''}
                    </div>
