...
import './components/slide-panel.js'; // [NEW] Slide Panel Manager

// [MỚI] Import AI modules
// [REMOVED] AI modules imports
...
import { initCalendarViews } from './calendar-views.js';
// import { initAdvancedFeatures } from './advanced-features.js'; 
// import { initDashboardToolbar } from './dashboard-toolbar.js'; 
// import { initDashboardWidgets } from './dashboard-widgets.js'; 
// import { initAITasksLite } from './ai-tasks-lite.js'; 
// import { initChatbotWeekly } from './chatbot-weekly.js'; 
// import { initTaskAnalytics } from './ai-task-analytics.js'; 
// import { initProductivity } from './ai-productivity.js'; 
// import { initCommunication } from './ai-communication.js'; 
// import { initDataAnalytics } from './ai-data-analytics.js'; 
// import { initAutomationEngine } from './ai-automation-engine.js'; 
// import { initAdvancedAI } from './ai-advanced.js'; 
// import { initAIPowerHub, renderPowerHubDashboard } from './ai-power-hub.js'; 
// import { initAIOnboarding } from './ai-onboarding.js'; 
// import { initLifeOS } from './lifeos-meta.js'; 
// import { initTemporal } from './lifeos-temporal.js'; 
// import { initCreative } from './lifeos-creative.js'; 
// import { initHyperAuto } from './lifeos-hyperauto.js'; 
import { updateAllBadges } from './sidebar-badges.js';
import { initWorkspaceHub } from './workspace-hub.js';
import { initGoalsModule } from './goals.js';
import { initWeeklyReview } from './weekly-review.js';
import { initGanttChart } from './gantt-chart.js';
...
// [MỚI] AI Phase 1 - 2026 Upgrade (25 features)
...
const initCoreModules = async (user, userData) => {
    ...
    // [MỚI] Workspace Hub - Phase 1 Features (Must init before WorkModule)
    initWorkspaceHub(userData, user);

    initWorkModule(userData, user);
    initStudyModule(userData, user);
    initGoalsModule(userData, user);
    initCalendarExport(userData, user);
...
const initAIModules = async (userData, user) => {
    // [DISABLED] Disable all AI modules
    /*
    setupAISettings();
    initAIStudy();
    ...
    try {
        await initAIPhase1();
        console.log('✅ AI Phase 1 (2026) initialized');
    } catch (error) {
        console.warn('⚠️ AI Phase 1 init error:', error);
    }
    */
    console.log('NOTICE: AI Modules are disabled.');
};
...
const initUIModules = (userData, user) => {
    ...
    // initSmartAIHub();
    console.log('NOTICE: Advanced UI Modules are disabled.');

    // [MỚI] Goals & Productivity Features
    initWeeklyReview(userData, user);
    initGanttChart(userData, user);
};
