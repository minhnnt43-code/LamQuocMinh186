...
window.filterAchievements = (type) => {
    ...
    // Màu gradient thống nhất (không phân loại tier nữa)
    const cardColor = 'linear-gradient(135deg, #005B96, #0088CC)';
    const badgeIcon = '🏆';

    // Stats counter đơn giản
    container.innerHTML = `
